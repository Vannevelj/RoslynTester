...
{
    [ExportCodeFixProvider("TestCodeFix", LanguageNames.CSharp), Shared]
    public class TestCodeFixWithErrorSeverity : CodeFixProvider
    {
        public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(SampleAnalyzer.TestAnalyzer.DiagnosticId);
