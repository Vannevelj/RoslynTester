...
{
    [ExportCodeFixProvider(nameof(SampleAnalyzer_VBAndCSharpCodeFix), LanguageNames.CSharp, LanguageNames.VisualBasic), Shared]
    public class SampleAnalyzer_VBAndCSharpCodeFix : CodeFixProvider
    {
        public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(SampleAnalyzer_VBAndCSharpAnalyzer.Rule.Id);
        ...
        public override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(CodeAction.Create("", x => AddFlagAttributeAsync(context.Document, root, statement), nameof(SampleAnalyzer_VBAndCSharpAnalyzer)), diagnostic);
        }
